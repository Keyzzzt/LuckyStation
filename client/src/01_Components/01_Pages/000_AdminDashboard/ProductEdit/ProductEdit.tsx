          ...
          <form onSubmit={handleSubmit}>
            <table className='stationTable'>
              ...
              <tr>
                ...
                <td>{user ? (
                  <>
                    <Button onClick={() => handleShowUser(user._id)} title={user.name} type='button' color='success'
                            padding='5px' marginRight='20px'/>
            ...
            <div className={s.buttons}>
              <Button title='Update' type='submit' color='success'/>
